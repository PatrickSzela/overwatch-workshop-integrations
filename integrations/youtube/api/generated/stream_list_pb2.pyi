...
class LiveChatMessageAuthorDetails(_message.Message):
    ...
    def __init__(self, channel_id: _Optional[str] = ..., channel_url: _Optional[str] = ..., display_name: _Optional[str] = ..., profile_image_url: _Optional[str] = ..., is_verified: bool = ..., is_chat_owner: bool = ..., is_chat_sponsor: bool = ..., is_chat_moderator: bool = ...) -> None: ...

class LiveChatMessageSnippet(_message.Message):
    __slots__ = ("type", "live_chat_id", "author_channel_id", "published_at", "has_display_content", "display_message", "text_message_details", "message_deleted_details", "message_retracted_details", "user_banned_details", "super_chat_details", "super_sticker_details", "new_sponsor_details", "member_milestone_chat_details", "membership_gifting_details", "gift_membership_received_details", "poll_details", "gift_details")
    class TypeWrapper(_message.Message):
        ...
        class Type(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            ...
            MESSAGE_DELETED_EVENT: _ClassVar[LiveChatMessageSnippet.TypeWrapper.Type]
            MESSAGE_RETRACTED_EVENT: _ClassVar[LiveChatMessageSnippet.TypeWrapper.Type]
        ...
        MESSAGE_DELETED_EVENT: LiveChatMessageSnippet.TypeWrapper.Type
        MESSAGE_RETRACTED_EVENT: LiveChatMessageSnippet.TypeWrapper.Type
    ...
    MESSAGE_DELETED_DETAILS_FIELD_NUMBER: _ClassVar[int]
    MESSAGE_RETRACTED_DETAILS_FIELD_NUMBER: _ClassVar[int]
...
class LiveChatMessageDeletedDetails(_message.Message):
    __slots__ = ("deleted_message_id",)
    DELETED_MESSAGE_ID_FIELD_NUMBER: _ClassVar[int]
    deleted_message_id: str
    def __init__(self, deleted_message_id: _Optional[str] = ...) -> None: ...

class LiveChatMessageRetractedDetails(_message.Message):
    __slots__ = ("retracted_message_id",)
    RETRACTED_MESSAGE_ID_FIELD_NUMBER: _ClassVar[int]
    retracted_message_id: str
    def __init__(self, retracted_message_id: _Optional[str] = ...) -> None: ...
...
class LiveChatNewSponsorDetails(_message.Message):
    ...
    is_upgrade: bool
    def __init__(self, member_level_name: _Optional[str] = ..., is_upgrade: bool = ...) -> None: ...
...
class LiveChatGiftDetails(_message.Message):
    ...
    combo_count: int
    def __init__(self, gift_name: _Optional[str] = ..., gift_duration: _Optional[int] = ..., jewels_amount: _Optional[int] = ..., gift_url: _Optional[str] = ..., alt_text: _Optional[str] = ..., language: _Optional[str] = ..., has_visual_effect: bool = ..., combo_count: _Optional[int] = ...) -> None: ...
